                                        ...
                                        <div class="modal-body">
                                          ...
                                          <form action="../../controller/edit_barang.php" method="POST">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="editNamaBarang" name="nama_barang" value="<?php echo $row['nama_barang']; ?>" placeholder="Nama Barang" required>
                                            </div>
                                            <div class="row">
                                              <div class="col">
                                                <div class="mb-3">
                                                    <label for="editKategori" class="form-label">Kategori</label>
                                                    <input type="text" class="form-control" id="editKategori" name="kategori" value="<?php echo $row['kategori']; ?>" placeholder="Kategori" required>
                                                </div>
                                              </div>
                                              <div class="col">
                                                <div class="mb-3">
                                                  <label for="editLokasi" class="form-label">Lokasi</label>
                                                  <input type="text" class="form-control" id="editLokasi" name="lokasi" value="<?php echo $row['lokasi']; ?>" placeholder="Lokasi" required>
                                                </div>
                                              </div>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="editDeskripsi" class="form-label">Deskripsi (Optional)</label>
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <form action="../../controller/stok_barang.php" method="POST">
                                            <div class="mb-3">
                                              ...
                                              <input type="number" class="form-control" id="tambahStok" name="jumlah_stok" placeholder="Masukkan jumlah stok yang ditambahkan" required>
                                            </div>
                                            <input type="hidden" name="id_barang" value="<?php echo $row['id_barang']; ?>">                                      
